...
export type Erc20InitParamsStruct = {
  name: string;
  symbol: string;
  deploymentId: string;
...
export type Erc20InitParamsStructOutput = [
  name: string,
  symbol: string,
  deploymentId: string,
  decimals: bigint,
...
export interface AirlockErc20TokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface AirlockErc20Token extends BaseContract {
  connect(runner?: ContractRunner | null): AirlockErc20Token;
  waitForDeployment(): Promise<this>;

  interface: AirlockErc20TokenInterface;
  ...
  filters: {
    ...
    "Deployed(address,address,string)": TypedContractEvent<
      DeployedEvent.InputTuple,
      DeployedEvent.OutputTuple,
      DeployedEvent.OutputObject
    >;
