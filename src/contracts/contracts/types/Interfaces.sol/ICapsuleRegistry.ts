...
export interface ICapsuleRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ICapsuleRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): ICapsuleRegistry;
  waitForDeployment(): Promise<this>;

  interface: ICapsuleRegistryInterface;
