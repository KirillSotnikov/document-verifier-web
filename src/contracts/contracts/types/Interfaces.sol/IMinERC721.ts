...
export interface IMinERC721Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "burn"
...
export interface IMinERC721 extends BaseContract {
  connect(runner?: ContractRunner | null): IMinERC721;
  waitForDeployment(): Promise<this>;

  interface: IMinERC721Interface;
