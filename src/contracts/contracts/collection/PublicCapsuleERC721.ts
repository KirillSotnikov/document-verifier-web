...
export interface PublicCapsuleERC721Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface PublicCapsuleERC721 extends BaseContract {
  connect(runner?: ContractRunner | null): PublicCapsuleERC721;
  waitForDeployment(): Promise<this>;

  interface: PublicCapsuleERC721Interface;
