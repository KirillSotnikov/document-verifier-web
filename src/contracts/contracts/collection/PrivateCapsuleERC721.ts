...
export interface PrivateCapsuleERC721Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface PrivateCapsuleERC721 extends BaseContract {
  connect(runner?: ContractRunner | null): PrivateCapsuleERC721;
  waitForDeployment(): Promise<this>;

  interface: PrivateCapsuleERC721Interface;
